...
namespace Common.Pagination
{
    ...
    public class PaginationQuery
    {
        ...
        /// </summary>
        private PaginationQuery(int? page, int? pageSize, [CanBeNull] string filter = null, [CanBeNull] string filterBy = null,
            [CanBeNull] string orderBy = null, [CanBeNull] string sort = null, bool ignoreCase = false, bool partialSearch = false)
        {
        ...
        public static PaginationQuery Create(int? page, int? pageSize, [CanBeNull] string filter = null, [CanBeNull] string filterBy = null,
            [CanBeNull] string orderBy = null, [CanBeNull] string sortDirection = null, bool ignoreCase = false, bool partialSearch = false)
        {
            return new PaginationQuery(page, pageSize, filter, filterBy, orderBy, sortDirection, ignoreCase, partialSearch);
        }
